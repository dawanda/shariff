...
"use strict";module.exports=function(e){var o=encodeURIComponent(e.getURL());return{popup:!1,iframe:!0,useCustomContent:!0,shareText:{de:"gefällt mir",en:"like"},name:"facebook-like",faName:"fa-facebook",title:{bg:"Сподели във Facebook",da:"Del på Facebook",de:"Bei Facebook teilen",en:"Share on Facebook",es:"Compartir en Facebook",fi:"Jaa Facebookissa",fr:"Partager sur Facebook",hr:"Podijelite na Facebooku",hu:"Megosztás Facebookon",it:"Condividi su Facebook",ja:"フェイスブック上で共有",ko:"페이스북에서 공유하기",nl:"Delen op Facebook",no:"Del på Facebook",pl:"Udostępnij na Facebooku",pt:"Compartilhar no Facebook",ro:"Partajează pe Facebook",ru:"Поделиться на Facebook",sk:"Zdieľať na Facebooku",sl:"Deli na Facebooku",sr:"Podeli na Facebook-u",sv:"Dela på Facebook",tr:"Facebook'ta paylaş",zh:"在Facebook上分享"},shareUrl:"http://www.facebook.com/v2.4/plugins/like.php?href="+o+e.getReferrerTrack()+"&width&layout=standard&action=like&show_faces=true&share=false&height=80",customContent:"<div id='fb-root'></div><script>(function(d, s, id) {var js, fjs = d.getElementsByTagName(s)[0];if (d.getElementById(id)) return;js = d.createElement(s); js.id = id;js.src = '//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.4';fjs.parentNode.insertBefore(js, fjs);}(document, 'script', 'facebook-jssdk'));</script><div class='fb-like' data-href='"+o+e.getReferrerTrack()+"' data-layout='standard' data-action='like' data-show-faces='false' data-share='false'></div>"}};
...
},{"url":5}],21:[function(require,module,exports){
...
(function (global){
"use strict";var $=(typeof window !== "undefined" ? window['jQuery'] : typeof global !== "undefined" ? global['jQuery'] : null),url=require("url"),Shariff=function(t,e){var i=this;this.element=t,$(t).empty(),this.options=$.extend({},this.defaults,e,$(t).data());var r=[require("./services/addthis"),require("./services/diaspora"),require("./services/facebook"),require("./services/facebook-like"),require("./services/flattr"),require("./services/googleplus"),require("./services/info"),require("./services/linkedin"),require("./services/mail"),require("./services/pinterest"),require("./services/reddit"),require("./services/stumbleupon"),require("./services/twitter"),require("./services/whatsapp"),require("./services/xing"),require("./services/tumblr"),require("./services/threema")];this.services=$.map(this.options.services,function(t){var e;return r.forEach(function(r){return r=r(i),r.name===t?(e=r,null):void 0}),e}),this._addButtonList(),null!==this.options.backendUrl&&this.getShares().then($.proxy(this._updateCounts,this))};Shariff.prototype={defaults:{theme:"color",backendUrl:null,infoUrl:"http://ct.de/-2467514",lang:"de",langFallback:"en",mailUrl:function(){var t=url.parse(this.getURL(),!0);return t.query.view="mail",delete t.search,url.format(t)},mailSubject:function(){return this.getMeta("DC.title")||this.getTitle()},mailBody:function(){return"<"+this.getURL()+">"},mediaUrl:null,orientation:"horizontal",referrerTrack:null,countDivisor:1e3,countDivisionStart:1e3,countRoundPrecision:0,services:["twitter","facebook","facebook-like","googleplus","info"],title:function(){return $("head title").text()},twitterVia:null,flattrUser:null,flattrCategory:null,url:function(){var t=global.document.location.href,e=$("link[rel=canonical]").attr("href")||this.getMeta("og:url")||"";return e.length>0&&(e.indexOf("http")<0&&(e=global.document.location.protocol+"//"+global.document.location.host+e),t=e),t}},$socialshareElement:function(){return $(this.element)},getLocalized:function(t,e){return"object"==typeof t[e]?"undefined"==typeof t[e][this.options.lang]?t[e][this.options.langFallback]:t[e][this.options.lang]:"string"==typeof t[e]?t[e]:void 0},getMeta:function(t){var e=$('meta[name="'+t+'"],[property="'+t+'"]').attr("content");return e||""},getInfoUrl:function(){return this.options.infoUrl},getURL:function(){return this.getOption("url")},getOption:function(t){var e=this.options[t];return"function"==typeof e?$.proxy(e,this)():e},getTitle:function(){return this.getOption("title")},getReferrerTrack:function(){return this.options.referrerTrack||""},getShares:function(){var t=url.parse(this.options.backendUrl,!0);return t.query.url=this.getURL(),delete t.search,$.getJSON(url.format(t))},getCountDivisor:function(){return this.options.countDivisor},getCountDivisionStart:function(){return this.options.countDivisionStart},getCountRoundPrecision:function(){return this.options.countRoundPrecision},_updateCounts:function(t){var e=this,i="";$.each(t,function(t,r){r>=e.getCountDivisionStart()&&(r=Math.round(r/e.getCountDivisor()),i="k"),$(e.element).find("."+t+" a").append('&nbsp;<span class="share_count">'+r)})},_addButtonList:function(){var t=this,e=this.$socialshareElement(),i="theme-"+this.options.theme,r="orientation-"+this.options.orientation,n="col-"+this.options.services.length,a=$("<ul>").addClass(i).addClass(r).addClass(n);this.services.forEach(function(e){var i=$('<li class="shariff-button">').addClass(e.name),r='<span class="share_text">'+t.getLocalized(e,"shareText"),n=$("<a>").attr("href",e.shareUrl).append(r);"undefined"!=typeof e.faName&&n.prepend('<span class="fa '+e.faName+'">'),e.popup?n.attr("data-rel","popup"):e.blank?n.attr("target","_blank"):e.iframe&&n.attr("rel","iframe"),e.customContent&&(n.attr("data-useCustomContent",e.useCustomContent),n.attr("data-customContent",e.customContent),n.attr("data-name",e.name)),n.attr("title",t.getLocalized(e,"title")),n.attr("role","button"),n.attr("aria-label",t.getLocalized(e,"title")),i.append(n),a.append(i)}),a.on("click",'[data-rel="popup"]',function(t){t.preventDefault();var e=$(this).attr("href"),i="_blank",r="600",n="460",a="width="+r+",height="+n;global.window.open(e,i,a)}),a.on("click",'[rel="iframe"]',function(t){t.preventDefault();var e=$(this).attr("href");$(this).data("width")&&$(this).parent().width($(this).data("width")),$(this).replaceWith('<iframe src="'+e+'"></iframe>')}),a.on("click",'[rel="tooltip"]',function(t){t.preventDefault();var e=$(this).attr("href"),i=$(this).offset().top-150,r=$(this).offset().left;$(this).data("width")&&$(this).parent().width($(this).data("width")),$("body").prepend('<div class="shariff-tooltip" style="top: '+i+"px; left: "+r+'px;">'+$(this).parent().data("popupinfotext")+'<br><br><iframe style="height: 30px;" src="'+e+'"></iframe></div></div>'),$(document).on("click",function(t){void 0===$(t.target).closest(".shariff-tooltip").get(0)&&void 0===$(t.target).closest("div.shariff").get(0)&&($(".shariff-tooltip").remove(),$(this).off(t))})}),a.on("click",'[rel="iframe"]',function(t){t.preventDefault();var e=$(this).attr("href");if($(this).data("width")&&$(this).parent().width($(this).data("width")),$(this).data("useCustomContent")){var i=$(this).data("customContent"),r=$(this).data("name");$(this).replaceWith("<div></div>");var n=$(this);$("<iframe name='"+r+"'></iframe>").load(function(){$("iframe [name='"+r+"']").contents().find("body").html(i)}).appendTo(n)}else $(this).replaceWith("<iframe src='"+e+"'></iframe>")}),e.append(a)}},module.exports=Shariff,global.Shariff=Shariff,$(".shariff").each(function(){this.hasOwnProperty("shariff")||(this.shariff=new Shariff(this))});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./services/addthis":6,"./services/diaspora":7,"./services/facebook":9,"./services/facebook-like":8,"./services/flattr":10,"./services/googleplus":11,"./services/info":12,"./services/linkedin":13,"./services/mail":14,"./services/pinterest":15,"./services/reddit":16,"./services/stumbleupon":17,"./services/threema":18,"./services/tumblr":19,"./services/twitter":20,"./services/whatsapp":21,"./services/xing":22,"url":5}]},{},[23]);
